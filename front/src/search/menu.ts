...
export const filterMenu = (config: ISearchOption, cb: () => void) => {
    ...
    <label class="fn__flex b3-label">
        ...
        <span class="fn__space"></span>
        <input class="b3-switch fn__flex-center" data-type="mathBlock" type="checkbox"${
					config.types.mathBlock ? ' checked' : ''
				}>
    </label>
    <label class="fn__flex b3-label">
        ...
        <span class="fn__space"></span>
        <input class="b3-switch fn__flex-center" data-type="table" type="checkbox"${
					config.types.table ? ' checked' : ''
				}>
    </label>
    <label class="fn__flex b3-label">
        ...
        <span class="fn__space"></span>
        <input class="b3-switch fn__flex-center" data-type="blockquote" type="checkbox"${
					config.types.blockquote ? ' checked' : ''
				}>
    </label>
    <label class="fn__flex b3-label">
        ...
        <span class="fn__space"></span>
        <input class="b3-switch fn__flex-center" data-type="superBlock" type="checkbox"${
					config.types.superBlock ? ' checked' : ''
				}>
    </label>
    <label class="fn__flex b3-label">
        ...
        <span class="fn__space"></span>
        <input class="b3-switch fn__flex-center" data-type="paragraph" type="checkbox"${
					config.types.paragraph ? ' checked' : ''
				}>
    </label>
    <label class="fn__flex b3-label">
        ...
        <span class="fn__space"></span>
        <input class="b3-switch fn__flex-center" data-type="document" type="checkbox"${
					config.types.document ? ' checked' : ''
				}>
    </label>
    <label class="fn__flex b3-label">
        ...
        <span class="fn__space"></span>
        <input class="b3-switch fn__flex-center" data-type="heading" type="checkbox"${
					config.types.heading ? ' checked' : ''
				}>
    </label>
    <label class="fn__flex b3-label">
    ...
    <label class="fn__flex b3-label">
        ...
        <span class="fn__space"></span>
        <input class="b3-switch fn__flex-center" data-type="listItem" type="checkbox"${
					config.types.listItem ? ' checked' : ''
				}>
    </label>
    <label class="fn__flex b3-label">
        ...
        <span class="fn__space"></span>
        <input class="b3-switch fn__flex-center" data-type="codeBlock" type="checkbox"${
					config.types.codeBlock ? ' checked' : ''
				}>
    </label>
    <label class="fn__flex b3-label">
        ...
        <span class="fn__space"></span>
        <input class="b3-switch fn__flex-center" data-type="htmlBlock" type="checkbox"${
					config.types.htmlBlock ? ' checked' : ''
				}>
    </label>
    <label class="fn__flex b3-label">
        ...
        <span class="fn__space"></span>
        <input class="b3-switch fn__flex-center" data-type="embedBlock" type="checkbox"${
					config.types.embedBlock ? ' checked' : ''
				}>
    </label>
    <label class="fn__flex b3-label">
        ...
        <span class="fn__space"></span>
        <input class="b3-switch fn__flex-center" data-type="databaseBlock" type="checkbox"${
					config.types.databaseBlock ? ' checked' : ''
				}>
    </label>
</div>
...
export const replaceFilterMenu = (config: ISearchOption) => {
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" data-type="${key}" type="checkbox"${
			config.replaceTypes[key] ? ' checked' : ''
		}>
</label>`;
	});
	const filterDialog = new Dialog({
...
const saveCriterionData = (
	...
	fetchPost('/api/storage/setCriterion', { criterion }, () => {
		...
		criteriaElement.insertAdjacentHTML(
			'beforeend',
			`<div data-type="set-criteria" class="b3-chip b3-chip--current b3-chip--middle b3-chip--pointer b3-chip--${
				['secondary', 'primary', 'info', 'success', 'warning', 'error', ''][criteriaElement.childElementCount % 7]
			}">${
				criterion.name
			}<svg class="b3-chip__close" data-type="remove-criteria"><use xlink:href="#iconCloseRound"></use></svg></div>`
		);
	});
};

export const saveCriterion = (config: ISearchOption, criteriaData: ISearchOption[], element: Element) => {
		...
		if (hasSameName && !hasSameConfig) {
			...
			if (hasSameName === hasSameConfig) {
				...
				confirmDialog(
					...
					window.siyuan.languages.searchRemoveName.replace('${x}', removeName).replace('${y}', value),
					() => {
						Array.from(criteriaElement.children).forEach((item) => {
			...
			confirmDialog(
				window.siyuan.languages.confirm,
				window.siyuan.languages.searchUpdateName.replace('${x}', hasSameConfig).replace('${y}', value),
				() => {
					Array.from(criteriaElement.children).forEach((item) => {
...
const configIsSame = (config: ISearchOption, config2: ISearchOption) => {
	if (
		config2.group === config.group &&
		config2.hPath === config.hPath &&
		config2.hasReplace === config.hasReplace &&
		config2.k === config.k &&
		config2.method === config.method &&
		config2.r === config.r &&
		config2.sort === config.sort &&
		objEquals(config2.types, config.types) &&
		objEquals(config2.replaceTypes, config.replaceTypes) &&
...
export const initCriteriaMenu = (element: HTMLElement, data: ISearchOption[], config: ISearchOption) => {
	fetchPost('/api/storage/getCriteria', {}, (response) => {
		...
		response.data.forEach((item: ISearchOption, index: number) => {
			...
			html += `<div data-type="set-criteria" class="${
				isSame ? 'b3-chip--current ' : ''
			}b3-chip b3-chip--middle b3-chip--pointer b3-chip--${
				['secondary', 'primary', 'info', 'success', 'warning', 'error', ''][index % 7]
			}">${escapeHtml(
				item.name
			)}<svg class="b3-chip__close" data-type="remove-criteria"><use xlink:href="#iconCloseRound"></use></svg></div>`;
		});

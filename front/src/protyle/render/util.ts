export const genIconHTML = (element?: false | HTMLElement) => {
    ...
    <span aria-label="${
		...
		}" class="b3-tooltips__nw b3-tooltips protyle-icon protyle-icon--first protyle-action__edit${
		enable ? '' : ' fn__none'
	}"><svg><use xlink:href="#iconEdit"></use></svg></span>
    <span aria-label="${
			window.siyuan.languages.more
		}" class="b3-tooltips__nw b3-tooltips protyle-icon protyle-action__menu protyle-icon--last${
		enable ? '' : ' protyle-icon--first'

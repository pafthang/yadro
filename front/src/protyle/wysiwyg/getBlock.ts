...
export const getTopAloneElement = (topSourceElement: Element) => {
	if (
		'NodeBlockquote' === topSourceElement.parentElement.getAttribute('data-type') &&
		...
		while (!topSourceElement.parentElement.classList.contains('protyle-wysiwyg')) {
			if (
				topSourceElement.parentElement.getAttribute('data-type') === 'NodeBlockquote' &&
				topSourceElement.parentElement.childElementCount === 2
			) {
		...
		'NodeSuperBlock' === topSourceElement.parentElement.getAttribute('data-type') &&
		topSourceElement.parentElement.childElementCount === 2
	) {
		while (!topSourceElement.parentElement.classList.contains('protyle-wysiwyg')) {
			if (
				topSourceElement.parentElement.getAttribute('data-type') === 'NodeSuperBlock' &&
				topSourceElement.parentElement.childElementCount === 2
			) {
				topSourceElement = topSourceElement.parentElement;
			} else {
		...
		'NodeListItem' === topSourceElement.parentElement.getAttribute('data-type') &&
		topSourceElement.parentElement.childElementCount === 3
	) {
		while (!topSourceElement.parentElement.classList.contains('protyle-wysiwyg')) {
			if (
				topSourceElement.parentElement.getAttribute('data-type') === 'NodeListItem' &&
				topSourceElement.parentElement.childElementCount === 3
			) {
				topSourceElement = topSourceElement.parentElement;
			} else if (
				topSourceElement.parentElement.getAttribute('data-type') === 'NodeList' &&
				topSourceElement.parentElement.childElementCount === 2
			) {
				topSourceElement = topSourceElement.parentElement;
			} else {

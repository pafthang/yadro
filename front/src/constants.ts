...
<path fill="#ffd00f" d="M13.868 6.478c0 0.946 0.767 1.712 1.712 1.712s1.712-0.767 1.712-1.712v0c0-0.945-0.766-1.712-1.712-1.712s-1.712 0.766-1.712 1.712v0zM28.577 10.818c0 0.945 0.766 1.712 1.712 1.712s1.712-0.766 1.712-1.712v0c0-0.945-0.766-1.712-1.712-1.712s-1.712 0.766-1.712 1.712v0zM0 10.822c0 0.945 0.766 1.712 1.712 1.712s1.712-0.766 1.712-1.712v0c0-0.945-0.766-1.712-1.712-1.712s-1.712 0.766-1.712 1.712v0z"></path>
	...
	// assets
	public static readonly SIYUAN_ASSETS_IMAGE: string[] = [
		'.apng',
		'.ico',
		'.cur',
		'.jpg',
	...
	public static readonly SIYUAN_ASSETS_EXTS: string[] = ['.pdf']
		.concat(Constants.SIYUAN_ASSETS_IMAGE)
		.concat(Constants.SIYUAN_ASSETS_AUDIO)
		.concat(Constants.SIYUAN_ASSETS_VIDEO);
	public static readonly SIYUAN_ASSETS_SEARCH: string[] = [
		'.txt',
		'.md',
		'.markdown',
		'.docx',
	...
	// protyle
	public static readonly SIYUAN_CONFIG_APPEARANCE_DARK_CODE: string[] = [
		'a11y-dark',
		'agate',
		'an-old-hope',
		'androidstudio',
	...
	public static readonly SIYUAN_CONFIG_APPEARANCE_LIGHT_CODE: string[] = [
		'ant-design',
		'a11y-light',
		'arduino-light',
		'ascetic',
	...
	public static readonly ALIAS_CODE_LANGUAGES: string[] = ['js', 'ts', 'html', 'toml', 'c#', 'bat'];

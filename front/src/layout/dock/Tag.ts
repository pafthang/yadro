...
export class Tag extends Model {
						...
						case 'transactions':
							data.data[0].doOperations.forEach((item: IOperation) => {
								...
								if (
									...
									item.data.indexOf('data-type="tag"') > -1
								) {
									needReload = true;
    ...
    <span class="fn__space"></span>
    <span data-type="sort" class="block__icon b3-tooltips b3-tooltips__sw${
			window.siyuan.config.readonly ? ' fn__none' : ''
    ...
    <span class="fn__space"></span>
    <span data-type="min" class="block__icon b3-tooltips b3-tooltips__sw" aria-label="${
...
<div class="fn__flex-1" style="margin-bottom: 8px"></div>`;
		...
		this.tree = new Tree({
			...
			blockExtHTML: window.siyuan.config.readonly
				? undefined
				: '<span class="b3-list-item__action"><svg><use xlink:href="#iconMore"></use></svg></span>',
			topExtHTML: window.siyuan.config.readonly
				? undefined
				: '<span class="b3-list-item__action"><svg><use xlink:href="#iconMore"></use></svg></span>'
		});
		// 为了快捷键的 dispatch

...
export const openFileAttr = (attrs: IObject, focusName = 'bookmark', protyle?: IProtyle) => {
    ...
    <input class="b3-text-field fn__block" type="datetime-local" max="9999-12-31 23:59" readonly data-name="${item}" value="${dayjs(
				attrs[item]
    ...
    <div class="fn__flex-1">
        <div class="custom-attr" data-type="attr">
            <label class="b3-label b3-label--noborder">
                ...
                <div class="fn__hr"></div>
                <input class="b3-text-field fn__block" placeholder="${
									window.siyuan.languages.attrBookmarkTip
								}" data-name="bookmark">
            </label>
            <label class="b3-label b3-label--noborder">
                ...
                <div class="fn__hr"></div>
                <input class="b3-text-field fn__block" placeholder="${
									window.siyuan.languages.attrNameTip
								}" data-name="name">
            </label>
            <label class="b3-label b3-label--noborder">
                ...
                <div class="fn__hr"></div>
                <input class="b3-text-field fn__block" placeholder="${
									window.siyuan.languages.attrAliasTip
								}" data-name="alias">
            </label>
            <label class="b3-label b3-label--noborder">
                ${window.siyuan.languages.memo}
                <div class="fn__hr"></div>
                <textarea class="b3-text-field fn__block" placeholder="${
									window.siyuan.languages.attrMemoTip
								}" rows="2" data-name="memo">${attrs.memo || ''}</textarea>
            </label>
            ${notifyHTML}
        </div>
	...
	(dialog.element.querySelector('.b3-text-field[data-name="bookmark"]') as HTMLInputElement).value =
		attrs.bookmark || '';
...
<div class="b3-dialog__action">
    ...
    <button class="b3-button b3-button--text">${window.siyuan.languages.confirm}</button>
				...
				btnsElement[1].addEventListener('click', () => {
					if (!isValidAttrName(inputElement.value)) {
						showMessage(
							window.siyuan.languages.attrName + ' <b>' + inputElement.value + '</b> ' + window.siyuan.languages.invalid
						);
						return false;
					}
    ...
    <textarea data-name="custom-${inputElement.value}" class="b3-text-field fn__block" rows="1" placeholder="${window.siyuan.languages.attrValue1}"></textarea>
					...
					const valueElement = target.parentElement.previousElementSibling.querySelector(
						'.b3-text-field'
					) as HTMLInputElement;
					valueElement.focus();
...
export const openMenu = (app: App, src: string, onlyMenu: boolean, showAccelerator: boolean) => {
	...
	if (isLocalPath(src)) {
		if (
			Constants.SIYUAN_ASSETS_EXTS.includes(pathPosix().extname(src)) &&
...
export const renameMenu = (options: { path: string; notebookId: string; name: string; type: 'notebook' | 'file' }) => {
	return new MenuItem({

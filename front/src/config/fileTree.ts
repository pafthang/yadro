...
export const fileTree = {
    ...
    <input class="b3-switch fn__flex-center" id="alwaysSelectOpenedFile" type="checkbox"${
			window.siyuan.config.fileTree.alwaysSelectOpenedFile ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="openFilesUseCurrentTab" type="checkbox"${
			window.siyuan.config.fileTree.openFilesUseCurrentTab ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="closeTabsOnStart" type="checkbox"${
			window.siyuan.config.fileTree.closeTabsOnStart ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="allowCreateDeeper" type="checkbox"${
			window.siyuan.config.fileTree.allowCreateDeeper ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="removeDocWithoutConfirm" type="checkbox"${
			window.siyuan.config.fileTree.removeDocWithoutConfirm ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="useSingleLineSave" type="checkbox"${
			window.siyuan.config.fileTree.useSingleLineSave ? ' checked' : ''
		}/>
</label>
...
<div class="b3-label fn__flex config__item">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="refCreateSavePath" value="${
			window.siyuan.config.fileTree.refCreateSavePath
		}">
</div>
<div class="fn__flex b3-label config__item">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="maxListCount" type="number" min="1" max="10240" value="${
			window.siyuan.config.fileTree.maxListCount
		}">
</div>
<div class="fn__flex b3-label config__item">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="maxOpenTabCount" type="number" min="1" max="32" value="${
	...
	_send() {
		...
		fetchPost(
			'/api/setting/setFiletree',
			{
				...
				removeDocWithoutConfirm: (fileTree.element.querySelector('#removeDocWithoutConfirm') as HTMLInputElement)
					.checked,
	...
	bindEvent: () => {
		(fileTree.element.querySelector('#docCreateSavePath') as HTMLInputElement).value =
			window.siyuan.config.fileTree.docCreateSavePath;
		(fileTree.element.querySelector('#refCreateSavePath') as HTMLInputElement).value =
			window.siyuan.config.fileTree.refCreateSavePath;

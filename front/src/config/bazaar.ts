...
<div class="fn__flex-1"></div>
		...
		const loadingHTML = `<div style="height: ${
			bazaar.element.clientHeight - 80
		}px;display: flex;align-items: center;justify-content: center;"><img src="/stage/loading-pure.svg"></div>`;
		return `<div class="fn__flex-column" style="height: 100%">
<div class="layout-tab-bar fn__flex">
    <div data-type="downloaded" class="item item--full item--focus"><span class="fn__flex-1"></span><span class="item__text">${
			window.siyuan.languages.downloaded
		}</span><span class="fn__flex-1"></span></div>
    <div data-type="plugin" class="item item--full"><span class="fn__flex-1"></span><span class="item__text">${
			window.siyuan.languages.plugin
		}</span><span class="fn__flex-1"></span></div>
    <div data-type="theme" class="item item--full"><span class="fn__flex-1"></span><span class="item__text">${
			window.siyuan.languages.theme
		}</span><span class="fn__flex-1"></span></div>
    <div data-type="icon" class="item item--full"><span class="fn__flex-1"></span><span class="item__text">${
			window.siyuan.languages.icon
		}</span><span class="fn__flex-1"></span></div>
    <div data-type="template" class="item item--full"><span class="fn__flex-1"></span><span class="item__text">${
			window.siyuan.languages.template
		}</span><span class="fn__flex-1"></span></div>
    <div data-type="widget" class="item item--full"><span class="fn__flex-1"></span><span class="item__text">${
...
<div class="fn__flex-1">
    <div class="config-bazaar__panel" data-type="downloaded" data-init="true">
        <div class="fn__flex config-bazaar__title">
            ...
            <div class="fn__space"></div>
            <button data-type="myTemplate" class="b3-button b3-button--outline">${
							window.siyuan.languages.template
						}</button>
            <div class="fn__space"></div>
            ...
            <div class="fn__flex-1"></div>
            <input ${
							window.siyuan.config.bazaar.petalDisabled ? '' : ' checked'
						} data-type="plugins-enable" type="checkbox" class="b3-switch" style="margin: 8px 16px">
            <div class="counter fn__none fn__flex-center b3-tooltips b3-tooltips__w" aria-label="${
							window.siyuan.languages.total
						}" style="background: var(--b3-theme-surface)"></div>
        </div>
    ...
    <div data-type="theme" class="config-bazaar__panel fn__none">
        <div class="fn__flex config-bazaar__title">
            ...
            <select class="b3-select">
                <option ${localSort.theme === '0' ? 'selected' : ''} value="0">${
			window.siyuan.languages.sortByUpdateTimeDesc
		}</option>
                <option ${localSort.theme === '1' ? 'selected' : ''} value="1">${
			window.siyuan.languages.sortByUpdateTimeAsc
		}</option>
                <option ${localSort.theme === '2' ? 'selected' : ''} value="2">${
			window.siyuan.languages.sortByDownloadsDesc
		}</option>
                <option ${localSort.theme === '3' ? 'selected' : ''} value="3">${
			window.siyuan.languages.sortByDownloadsAsc
		}</option>
            </select>
            <div class="fn__space"></div>
            ...
            <div class="fn__space"></div>
            <div class="fn__flex-1"></div>
            <div class="counter fn__flex-center b3-tooltips b3-tooltips__w" aria-label="${
							window.siyuan.languages.total
						}" style="background: var(--b3-theme-surface)"></div>
        </div>
    ...
    <div class="fn__none config-bazaar__panel" data-type="template">
        <div class="fn__flex config-bazaar__title">
            ...
            <div class="fn__space"></div>
            <select class="b3-select">
                <option ${localSort.template === '0' ? 'selected' : ''} value="0">${
			window.siyuan.languages.sortByUpdateTimeDesc
		}</option>
                <option ${localSort.template === '1' ? 'selected' : ''} value="1">${
			window.siyuan.languages.sortByUpdateTimeAsc
		}</option>
                <option ${localSort.template === '2' ? 'selected' : ''} value="2">${
			window.siyuan.languages.sortByDownloadsDesc
		}</option>
                <option ${localSort.template === '3' ? 'selected' : ''} value="3">${
			window.siyuan.languages.sortByDownloadsAsc
		}</option>
            </select>
            <div class="fn__space"></div>
    ...
    <div class="fn__none config-bazaar__panel" data-type="plugin">
        <div class="fn__flex config-bazaar__title">
            ...
            <div class="fn__space"></div>
            <select class="b3-select">
                <option ${localSort.plugin === '0' ? 'selected' : ''} value="0">${
			window.siyuan.languages.sortByUpdateTimeDesc
		}</option>
                <option ${localSort.plugin === '1' ? 'selected' : ''} value="1">${
			window.siyuan.languages.sortByUpdateTimeAsc
		}</option>
                <option ${localSort.plugin === '2' ? 'selected' : ''} value="2">${
			window.siyuan.languages.sortByDownloadsDesc
		}</option>
                <option ${localSort.plugin === '3' ? 'selected' : ''} value="3">${
			window.siyuan.languages.sortByDownloadsAsc
		}</option>
            </select>
            <div class="fn__space"></div>
    ...
    <div class="fn__none config-bazaar__panel" data-type="icon">
        <div class="fn__flex config-bazaar__title">
            ...
            <div class="fn__space"></div>
            <select class="b3-select">
                <option ${localSort.icon === '0' ? 'selected' : ''} value="0">${
			window.siyuan.languages.sortByUpdateTimeDesc
		}</option>
                <option ${localSort.icon === '1' ? 'selected' : ''} value="1">${
			window.siyuan.languages.sortByUpdateTimeAsc
		}</option>
                <option ${localSort.icon === '2' ? 'selected' : ''} value="2">${
			window.siyuan.languages.sortByDownloadsDesc
		}</option>
                <option ${localSort.icon === '3' ? 'selected' : ''} value="3">${
			window.siyuan.languages.sortByDownloadsAsc
		}</option>
            </select>
            <div class="fn__space"></div>
    ...
    <div class="fn__none config-bazaar__panel" data-type="widget">
        <div class="fn__flex config-bazaar__title">
            ...
            <div class="fn__space"></div>
            <select class="b3-select">
                <option ${localSort.widget === '0' ? 'selected' : ''} value="0">${
			window.siyuan.languages.sortByUpdateTimeDesc
		}</option>
                <option ${localSort.widget === '1' ? 'selected' : ''} value="1">${
			window.siyuan.languages.sortByUpdateTimeAsc
		}</option>
                <option ${localSort.widget === '2' ? 'selected' : ''} value="2">${
			window.siyuan.languages.sortByDownloadsDesc
		}</option>
                <option ${localSort.widget === '3' ? 'selected' : ''} value="3">${
			window.siyuan.languages.sortByDownloadsAsc
		}</option>
            </select>
            <div class="fn__space"></div>
...
<div id="configBazaarReadme" class="config-bazaar__readme"></div>
	...
	_genCardHTML(item: IBazaarItem, bazaarType: TBazaarType) {
		...
		if (bazaarType === 'themes') {
			...
			if ((themeValue === '0' && item.modes.includes('dark')) || (themeValue === '1' && item.modes.includes('light'))) {
				hide = true;
			}
		...
		return `<div data-obj='${JSON.stringify(dataObj)}' class="b3-card b3-card--wrap${hide ? ' fn__none' : ''}${
			item.current ? ' b3-card--current' : ''
		}">
        ...
        <div class="b3-card__actions">
            ...
            ${
							item.preferredFunding
								? `<a target="_blank" href="${item.preferredFunding}" class="block__icon block__icon--show ariaLabel" aria-label="${window.siyuan.languages.sponsor} ${item.preferredFunding}"><svg class="ft__pink"><use xlink:href="#iconHeart"></use></svg></a><span class="fn__space"></span>`
								: ''
						}
            <div class="fn__flex-1"></div>
            <span class="b3-tooltips b3-tooltips__nw block__icon block__icon--show${
							item.installed ? '' : ' fn__none'
						}" data-type="uninstall" aria-label="${window.siyuan.languages.uninstall}">
                <svg><use xlink:href="#iconTrashcan"></use></svg>
            </span>
            <div class="fn__space${!item.current && item.installed && showSwitch ? '' : ' fn__none'}"></div>
            <span class="b3-tooltips b3-tooltips__nw block__icon block__icon--show${
							!item.current && item.installed && showSwitch ? '' : ' fn__none'
						}" data-type="switch" aria-label="${window.siyuan.languages.use}">
            ...
            <span data-type="install-t" class="b3-tooltips b3-tooltips__nw block__icon block__icon--show${
							item.outdated ? '' : ' fn__none'
						}" aria-label="${window.siyuan.languages.update}">
	...
	_genMyHTML(bazaarType: TBazaarType, app: App) {
		...
		if (
			contentElement.getAttribute('data-loading') === 'true' ||
			contentElement.previousElementSibling
				.querySelector(
					`[data-type="my${bazaarType
						.replace(bazaarType[0], bazaarType[0].toUpperCase())
						.substring(0, bazaarType.length - 1)}"]`
				)
				.classList.contains('b3-button--outline')
		) {
			return;
		}
		...
		fetchPost(
			url,
			{
				...
				keyword:
					(contentElement.previousElementSibling.querySelector('.b3-text-field') as HTMLInputElement)?.value || ''
			},
			(response) => {
				...
				if (response.data.packages.length === 0) {
					...
					response.data.packages.forEach((item: IBazaarItem) => {
						...
						html += `<div data-obj='${JSON.stringify(dataObj)}' class="b3-card${
							item.current ? ' b3-card--current' : ''
						}${window.siyuan.config.bazaar.petalDisabled && bazaarType === 'plugins' ? ' b3-card--disabled' : ''}">
    ...
    <div class="b3-card__actions b3-card__actions--right">
        ${
					item.incompatible
						? `<span class="fn__space"></span><span class="fn__flex-center b3-tooltips b3-tooltips__nw b3-chip b3-chip--error b3-chip--small" aria-label="${window.siyuan.languages.incompatiblePluginTip}">${window.siyuan.languages.incompatible}</span>`
						: ''
				}
        ${
					item.preferredFunding
						? `<a target="_blank" href="${item.preferredFunding}" class="block__icon block__icon--show ariaLabel" aria-label="${window.siyuan.languages.sponsor} ${item.preferredFunding}"><svg class="ft__pink"><use xlink:href="#iconHeart"></use></svg></a>`
						: ''
				}
        <span class="b3-tooltips b3-tooltips__nw block__icon block__icon--show${
					hasSetting ? '' : ' fn__none'
				}" data-type="setting" aria-label="${window.siyuan.languages.config}">
            <svg><use xlink:href="#iconSettings"></use></svg>
        </span>
        <span class="b3-tooltips b3-tooltips__nw block__icon block__icon--show" data-type="uninstall" aria-label="${
					window.siyuan.languages.uninstall
				}">
            <svg><use xlink:href="#iconTrashcan"></use></svg>
        </span>
        <span class="b3-tooltips b3-tooltips__nw block__icon block__icon--show${
					isBrowser() ? ' fn__none' : ''
				}" data-type="open" aria-label="${window.siyuan.languages.showInFolder}">
            <svg><use xlink:href="#iconFolder"></use></svg>
        </span>
        <span class="b3-tooltips b3-tooltips__nw block__icon block__icon--show${
					!item.current && showSwitch ? '' : ' fn__none'
				}" data-type="switch" aria-label="${window.siyuan.languages.use}">
            <svg><use xlink:href="#iconSelect"></use></svg>
        </span>
        <span data-type="install-t" aria-label="${
					window.siyuan.languages.update
				}" class="b3-tooltips b3-tooltips__nw block__icon block__icon--show${item.outdated ? '' : ' fn__none'}">
            <svg class="ft__primary"><use xlink:href="#iconRefresh"></use></svg>
        </span>
        <span class="fn__space${bazaarType === 'plugins' ? '' : ' fn__none'}"></span>
        <span class="fn__space${bazaarType === 'plugins' ? '' : ' fn__none'}"></span>
        <input class="b3-switch fn__flex-center${bazaarType === 'plugins' ? '' : ' fn__none'}" ${
							item.enabled ? 'checked' : ''
						} data-type="plugin-enable" type="checkbox" ${item.incompatible ? ' disabled' : ''}>
    </div>
</div>`;
					});
				}
				...
				contentElement.innerHTML = html
					? html
					: `<div class="fn__hr"></div><ul class="b3-list b3-list--background"><li class="b3-list--empty">${window.siyuan.languages.emptyContent}</li></ul>`;
			}
		);
	},
	_data: {
    ...
    <div class="fn__flex">
        <div style="padding-right: 8px" class="block__icon block__icon--show b3-tooltips b3-tooltips__e" data-type="goBack" aria-label="${
    ...
    <div class="fn__hr--b"></div>
    <div class="fn__hr--b"></div>
    <div class="ft__on-surface ft__smaller" style="line-height: 20px;">${window.siyuan.languages.currentVer}<br>v${
			data.version
		}</div>
    <div class="fn__hr"></div>
    <div class="ft__on-surface ft__smaller" style="line-height: 20px;">${
			dataObj.downloaded ? window.siyuan.languages.installDate : window.siyuan.languages.releaseDate
		}<br>${dataObj.downloaded ? data.hInstallDate : data.hUpdated}</div>
    <div class="fn__hr"></div>
    <div class="ft__on-surface ft__smaller" style="line-height: 20px;">${
			dataObj.downloaded ? window.siyuan.languages.installSize : window.siyuan.languages.pkgSize
		}<br>${dataObj.downloaded ? data.hInstallSize : data.hSize}</div>
...
<div class="item__main">
	...
	bindEvent(app: App) {
		...
		bazaar.element.firstElementChild.addEventListener('click', (event) => {
			...
			while (target && !target.isEqualNode(bazaar.element)) {
				...
				if (target.tagName === 'A') {
					...
					if (
						target.classList.contains('b3-button--outline') &&
							...
							async (response) => {
								...
								if (bazaarType === 'plugins') {
									if (window.siyuan.config.bazaar.petalDisabled) {
										...
										confirmDialog(
											'💡 ' + window.siyuan.languages.enablePlugin,
											window.siyuan.languages.enablePluginTip,
											() => {
												fetchPost(
					...
					if (
						window.siyuan.config.appearance.themeDark === packageName ||
						...
						confirmDialog(
							'⚠️ ' + window.siyuan.languages.uninstall,
							window.siyuan.languages.confirmUninstall.replace('${name}', packageName),
							() => {
								fetchPost(
									url,
									{
					...
					if (bazaarType === 'icons') {
						fetchPost(
							...
							Object.assign({}, window.siyuan.config.appearance, {
								icon: packageName
							}),
							(appearanceResponse) => {
								this._genMyHTML(bazaarType, app);
		...
		bazaar.element
			.querySelectorAll('.config-bazaar__panel .b3-form__icon > .b3-text-field')
			.forEach((inputElement: HTMLInputElement) => {
				inputElement.addEventListener('keydown', (event) => {
					...
					if (event.key === 'Enter') {
						...
						const type = (hasClosestByClassName(inputElement, 'config-bazaar__panel') as HTMLElement).getAttribute(
							'data-type'
						);
						if (type === 'template') {
							...
							const bazaarType = (inputElement.parentElement.parentElement
								.querySelector('.b3-button:not(.b3-button--outline)')
								.getAttribute('data-type')
								.replace('my', '')
								.toLowerCase() + 's') as TBazaarType;
							this._genMyHTML(bazaarType, app);
						}
						event.preventDefault();
						return;
		...
		bazaar.element.querySelectorAll('.b3-select').forEach((selectElement: HTMLSelectElement) => {
			selectElement.addEventListener('change', (event) => {
				if (selectElement.id === 'bazaarSelect') {
					...
					(event.target as HTMLElement).parentElement.querySelector('.counter').textContent = bazaar.element
						.querySelectorAll('#configBazaarTheme .b3-card:not(.fn__none)')
						.length.toString();
				} else {
					// sort
					const localSort = window.siyuan.storage[Constants.LOCAL_BAZAAR];
					...
					if (selectElement.value === '0') {
						...
						cardElements
							.sort((a, b) => {
								return JSON.parse(b.getAttribute('data-obj')).updated < JSON.parse(a.getAttribute('data-obj')).updated
									? -1
									: 1;
							})
							.forEach((item) => {
						...
						cardElements
							.sort((a, b) => {
								return JSON.parse(b.getAttribute('data-obj')).downloads <
									JSON.parse(a.getAttribute('data-obj')).downloads
									? -1
									: 1;
							})
							.forEach((item) => {
					...
					if (cardElements.length > 1) {
						html +=
							'<div class="fn__flex-1" style="margin-left: 15px;min-width: 342px;"></div><div class="fn__flex-1" style="margin-left: 15px;min-width: 342px;"></div>';
					}
	...
	_onBazaar(response: IWebSocketData, bazaarType: TBazaarType, reload: boolean) {
		...
		element.parentElement.querySelector('.counter').textContent = element
			.querySelectorAll('.b3-card:not(.fn__none)')
			.length.toString();
		const localSort = window.siyuan.storage[Constants.LOCAL_BAZAAR];
		if (localSort[bazaarType.replace('s', '')] === '1') {
			html = '';
			Array.from(element.querySelectorAll('.b3-card'))
				.sort((a, b) => {
					return JSON.parse(b.getAttribute('data-obj')).updated < JSON.parse(a.getAttribute('data-obj')).updated
						? 1
						: -1;
		...
		} else if (localSort[bazaarType.replace('s', '')] === '2') {
			// 下载次数降序
			html = '';
			Array.from(element.querySelectorAll('.b3-card'))
				.sort((a, b) => {
					return JSON.parse(b.getAttribute('data-obj')).downloads < JSON.parse(a.getAttribute('data-obj')).downloads
						? -1
						: 1;
				})
				.forEach((item) => {
		...
		} else if (localSort[bazaarType.replace('s', '')] === '3') {
			// 下载次数升序
			html = '';
			Array.from(element.querySelectorAll('.b3-card'))
				.sort((a, b) => {

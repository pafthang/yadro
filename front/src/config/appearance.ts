...
export const appearance = {
    ...
    <select class="b3-select fn__flex-center fn__size200" id="mode">
      <option value="0" ${
				window.siyuan.config.appearance.mode === 0 && !window.siyuan.config.appearance.modeOS ? 'selected' : ''
			}>${window.siyuan.languages.themeLight}</option>
      <option value="1" ${
				window.siyuan.config.appearance.mode === 1 && !window.siyuan.config.appearance.modeOS ? 'selected' : ''
			}>${window.siyuan.languages.themeDark}</option>
      <option value="2" ${window.siyuan.config.appearance.modeOS ? 'selected' : ''}>${
			window.siyuan.languages.themeOS
		}</option>
    </select>
</div>
<div class="b3-label">
    <div class="fn__flex">
        ...
        <a href="javascript:void(0)" ${
					isBrowser() ? " class='fn__none'" : ''
				} id="appearanceOpenTheme" class="fn__flex-center">${window.siyuan.languages.appearance9}</a>
    </div>
...
<div class="fn__flex b3-label config__item">
    <div class="fn__flex-1">
        <div class="fn__flex">
            ...
            <span class="fn__space"></span>
            <a href="javascript:void(0)"${isBrowser() ? " class='fn__none'" : ''} id="appearanceOpenIcon">${
...
<div class="fn__flex b3-label config__item">
    ...
    <span class="fn__space"></span>
    <select id="lang" class="b3-select fn__flex-center fn__size200">${genOptions(
			window.siyuan.config.langs,
...
<label class="fn__flex b3-label">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="hideStatusBar" type="checkbox"${
			window.siyuan.config.appearance.hideStatusBar ? ' checked' : ''
		}>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="closeButtonBehavior" type="checkbox"${
			window.siyuan.config.appearance.closeButtonBehavior === 0 ? '' : ' checked'
		}>
</label>`;
	},
	_send: () => {
		...
		fetchPost(
			'/api/setting/setAppearance',
			{
				...
				closeButtonBehavior: (appearance.element.querySelector('#closeButtonBehavior') as HTMLInputElement).checked
					? 1
					: 0,
	...
	onSetappearance(data: IAppearance) {
		...
		if (appearance.element) {
			...
			if (themeLightElement) {
				themeLightElement.innerHTML = genOptions(
					window.siyuan.config.appearance.lightThemes,
			...
			if (themeDarkElement) {
				themeDarkElement.innerHTML = genOptions(
					window.siyuan.config.appearance.darkThemes,

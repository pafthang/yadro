...
export const exportConfig = {
    ...
    <input class="b3-switch fn__flex-center" id="paragraphBeginningSpace" type="checkbox"${
			window.siyuan.config.export.paragraphBeginningSpace ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="addTitle" type="checkbox"${
			window.siyuan.config.export.addTitle ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="markdownYFM" type="checkbox"${
			window.siyuan.config.export.markdownYFM ? ' checked' : ''
		}/>
</label>
<div class="fn__flex b3-label config__item">
    ...
    <select id="blockRefMode" class="b3-select fn__flex-center fn__size200">
        <option value="2" ${window.siyuan.config.export.blockRefMode === 2 ? 'selected' : ''}>${
			window.siyuan.languages.export2
		}</option>
        <option value="3" ${window.siyuan.config.export.blockRefMode === 3 ? 'selected' : ''}>${
			window.siyuan.languages.export3
		}</option>
        <option value="4" ${window.siyuan.config.export.blockRefMode === 4 ? 'selected' : ''}>${
			window.siyuan.languages.export4
		}</option>
        <option value="5" ${window.siyuan.config.export.blockRefMode === 5 ? 'selected' : ''}>${
...
<div class="fn__flex b3-label config__item">
    ...
    <select id="blockEmbedMode" class="b3-select fn__flex-center fn__size200">
        <option value="0" ${window.siyuan.config.export.blockEmbedMode === 0 ? 'selected' : ''}>${
			window.siyuan.languages.export0
		}</option>
        <option value="1" ${window.siyuan.config.export.blockEmbedMode === 1 ? 'selected' : ''}>${
			window.siyuan.languages.export1
		}</option>
    </select>
</div>
<div class="fn__flex b3-label config__item">
    ...
    <select id="fileAnnotationRefMode" class="b3-select fn__flex-center fn__size200">
        <option value="0" ${window.siyuan.config.export.fileAnnotationRefMode === 0 ? 'selected' : ''}>${
			window.siyuan.languages.export7
		}</option>
        <option value="1" ${window.siyuan.config.export.fileAnnotationRefMode === 1 ? 'selected' : ''}>${
			window.siyuan.languages.export8
		}</option>
    </select>
</div>
<div class="fn__flex b3-label config__item">
...
<div class="b3-label config__item">
    ...
    <div class="fn__hr"></div>
    <div class="b3-label__text"><a href="https://pdfcpu.io/core/watermark#description" target="_blank">${
...
<div class="fn__flex b3-label config__item${isBrowser() ? ' fn__none' : ''}">
    <div class="fn__flex-1">
        ...
        <span class="fn__space"></span>
        <a href="javascript:void(0)" id="pandocBinPath" style="word-break: break-all">${
					window.siyuan.config.export.pandocBin
				}</a>
        <div class="b3-label__text">${window.siyuan.languages.export20}</div>
    </div>
    <span class="fn__space"></span>
    <button class="b3-button b3-button--outline fn__flex-center fn__size200" id="pandocBin"><svg><use xlink:href="#iconSettings"></use></svg>${
...
<div class="fn__flex b3-label config__item">
	...
	bindEvent: () => {
		(exportConfig.element.querySelector('#docxTemplate') as HTMLInputElement).value =
			window.siyuan.config.export.docxTemplate;
		(exportConfig.element.querySelector('#pdfFooter') as HTMLInputElement).value =
			window.siyuan.config.export.pdfFooter;
		(exportConfig.element.querySelector('#pdfWatermarkStr') as HTMLInputElement).value =
			window.siyuan.config.export.pdfWatermarkStr;
		(exportConfig.element.querySelector('#pdfWatermarkDesc') as HTMLInputElement).value =
			window.siyuan.config.export.pdfWatermarkDesc;
		(exportConfig.element.querySelector('#imageWatermarkStr') as HTMLInputElement).value =
			window.siyuan.config.export.imageWatermarkStr;
		(exportConfig.element.querySelector('#imageWatermarkDesc') as HTMLInputElement).value =
			window.siyuan.config.export.imageWatermarkDesc;
		(exportConfig.element.querySelector('#blockRefTextLeft') as HTMLInputElement).value =
			window.siyuan.config.export.blockRefTextLeft;
		(exportConfig.element.querySelector('#blockRefTextRight') as HTMLInputElement).value =
			window.siyuan.config.export.blockRefTextRight;
		(exportConfig.element.querySelector('#tagOpenMarker') as HTMLInputElement).value =
			window.siyuan.config.export.tagOpenMarker;
		(exportConfig.element.querySelector('#tagCloseMarker') as HTMLInputElement).value =
			window.siyuan.config.export.tagCloseMarker;
		...
		const setexprt = (pandocBin?: string) => {
			fetchPost(
				...
				{
					paragraphBeginningSpace: (exportConfig.element.querySelector('#paragraphBeginningSpace') as HTMLInputElement)
						.checked,
					...
					blockEmbedMode: parseInt(
						(exportConfig.element.querySelector('#blockEmbedMode') as HTMLSelectElement).value,
						10
					),
					fileAnnotationRefMode: parseInt(
						(exportConfig.element.querySelector('#fileAnnotationRefMode') as HTMLSelectElement).value,
						10
					),

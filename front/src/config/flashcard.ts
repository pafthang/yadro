...
export const flashcard = {
    ...
    <input class="b3-switch fn__flex-center" id="mark" type="checkbox"${
			window.siyuan.config.flashcard.mark ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="list" type="checkbox"${
			window.siyuan.config.flashcard.list ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="heading" type="checkbox"${
			window.siyuan.config.flashcard.heading ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="superBlock" type="checkbox"${
			window.siyuan.config.flashcard.superBlock ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="deck" type="checkbox"${
			window.siyuan.config.flashcard.deck ? ' checked' : ''
		}/>
</label>
<div class="fn__flex b3-label config__item">
    ...
    <select class="b3-select fn__flex-center fn__size200" id="reviewMode">
      <option value="0" ${window.siyuan.config.flashcard.reviewMode === 0 ? 'selected' : ''}>${
			window.siyuan.languages.reviewMode0
		}</option>
      <option value="1" ${window.siyuan.config.flashcard.reviewMode === 1 ? 'selected' : ''}>${
			window.siyuan.languages.reviewMode1
		}</option>
      <option value="2" ${window.siyuan.config.flashcard.reviewMode === 2 ? 'selected' : ''}>${
			window.siyuan.languages.reviewMode2
		}</option>
    </select>    
</div>`;
		/// #if MOBILE
    ...
    <input class="b3-text-field fn__block" id="newCardLimit" step="1" min="0" type="number"${
			window.siyuan.config.flashcard.newCardLimit ? ' checked' : ''
		} value="${window.siyuan.config.flashcard.newCardLimit}"/>
...
<div class="b3-label">
    ...
    <div class="fn__hr"></div>
    <input class="b3-text-field fn__block" id="reviewCardLimit" step="1" min="0" type="number"${
			window.siyuan.config.flashcard.reviewCardLimit ? ' checked' : ''
		} value="${window.siyuan.config.flashcard.reviewCardLimit}"/>
...
<div class="b3-label">
    ...
    <div class="fn__hr"></div>
    <input class="b3-text-field fn__block" id="requestRetention" step="0.01" min="0" max="1" type="number" value="${
			window.siyuan.config.flashcard.requestRetention
		}"/>
...
<div class="b3-label">
    ...
    <div class="fn__hr"></div>
    <input class="b3-text-field fn__block" id="maximumInterval" step="1" min="365" max="36500" type="number" value="${
			window.siyuan.config.flashcard.maximumInterval
		}"/>
...
<div class="b3-label">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="newCardLimit" step="1" min="0" type="number"${
			window.siyuan.config.flashcard.newCardLimit ? ' checked' : ''
		} value="${window.siyuan.config.flashcard.newCardLimit}"/>
</div>
<div class="fn__flex b3-label">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="reviewCardLimit" step="1" min="0" type="number"${
			window.siyuan.config.flashcard.reviewCardLimit ? ' checked' : ''
		} value="${window.siyuan.config.flashcard.reviewCardLimit}"/>
</div>
<div class="fn__flex b3-label">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="requestRetention" step="0.01" min="0" max="1" type="number" value="${
			window.siyuan.config.flashcard.requestRetention
		}"/>
</div>
<div class="fn__flex b3-label">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="maximumInterval" step="1" min="365" max="36500" type="number" value="${
			window.siyuan.config.flashcard.maximumInterval
		}"/>
</div>
<div class="fn__flex b3-label">
				...
				fetchPost(
					'/api/setting/setFlashcard',
					{
						...
						requestRetention: parseFloat(
							(flashcard.element.querySelector('#requestRetention') as HTMLInputElement).value
						),

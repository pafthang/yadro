 ...
 ${window.siyuan.languages.searchBlockType}
    <div class="fn__flex config-query">
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="mathBlock" type="checkbox"${
							window.siyuan.config.search.mathBlock ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
        ...
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="blockquote" type="checkbox"${
							window.siyuan.config.search.blockquote ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="superBlock" type="checkbox"${
							window.siyuan.config.search.superBlock ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="paragraph" type="checkbox"${
							window.siyuan.config.search.paragraph ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="document" type="checkbox"${
							window.siyuan.config.search.document ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="heading" type="checkbox"${
							window.siyuan.config.search.heading ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
        ...
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="listItem" type="checkbox"${
							window.siyuan.config.search.listItem ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="codeBlock" type="checkbox"${
							window.siyuan.config.search.codeBlock ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="htmlBlock" type="checkbox"${
							window.siyuan.config.search.htmlBlock ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="embedBlock" type="checkbox"${
							window.siyuan.config.search.embedBlock ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="databaseBlock" type="checkbox"${
							window.siyuan.config.search.databaseBlock ? ' checked' : ''
						}/>
        </label>        
    </div>
</div>
 ...
 ${window.siyuan.languages.searchBackmention}
    <div class="config-query">
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="backlinkMentionName" type="checkbox"${
							window.siyuan.config.search.backlinkMentionName ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            <div class="fn__flex-1">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="backlinkMentionAlias" type="checkbox"${
							window.siyuan.config.search.backlinkMentionAlias ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            <div class="fn__flex-1">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="backlinkMentionAnchor" type="checkbox"${
							window.siyuan.config.search.backlinkMentionAnchor ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            <div class="fn__flex-1">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="backlinkMentionDoc" type="checkbox"${
							window.siyuan.config.search.backlinkMentionDoc ? ' checked' : ''
						}/>
        </label>
        <div class="fn__flex label" style="flex: 2">
            ...
            <span class="fn__space"></span>
            <input class="b3-text-field" id="backlinkMentionKeywordsLimit" type="number" min="1" max="10240" value="${
							window.siyuan.config.search.backlinkMentionKeywordsLimit
						}">
        </div>
    </div>
</div>
 ...
 ${window.siyuan.languages.searchVirtualRef}
    <div class="config-query">
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="virtualRefName" type="checkbox"${
							window.siyuan.config.search.virtualRefName ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            <div class="fn__flex-1">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="virtualRefAlias" type="checkbox"${
							window.siyuan.config.search.virtualRefAlias ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            <div class="fn__flex-1">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="virtualRefAnchor" type="checkbox"${
							window.siyuan.config.search.virtualRefAnchor ? ' checked' : ''
						}/>
        </label>
        <label class="fn__flex">
            <div class="fn__flex-1">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="virtualRefDoc" type="checkbox"${
							window.siyuan.config.search.virtualRefDoc ? ' checked' : ''
						}/>
        </label>
    </div>
</div>
 ...
 ${window.siyuan.languages.searchIndex}
    <div class="config-query">
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <input class="b3-switch" id="indexAssetPath" type="checkbox"${
							window.siyuan.config.search.indexAssetPath ? ' checked' : ''
						}/>
        </label>
    </div>
</div>
<div class="fn__flex b3-label config__item">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="limit" type="number" min="32" max="10240" value="${
			window.siyuan.config.search.limit
		}">
</div>
<label class="fn__flex b3-label">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="caseSensitive" type="checkbox"${
			window.siyuan.config.search.caseSensitive ? ' checked' : ''
		}/>
</label>`;
	},
	bindEvent: () => {
			...
			item.addEventListener('change', () => {
				fetchPost(
					'/api/setting/setSearch',
					{
						...
						backlinkMentionKeywordsLimit: parseInt(
							(query.element.querySelector('#backlinkMentionKeywordsLimit') as HTMLInputElement).value
						),

...
export const editor = {
    ...
    <input class="b3-switch fn__flex-center" id="fullWidth" type="checkbox"${
			window.siyuan.config.editor.fullWidth ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="justify" type="checkbox"${
			window.siyuan.config.editor.justify ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="rtl" type="checkbox"${
			window.siyuan.config.editor.rtl ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="readOnly" type="checkbox"${
			window.siyuan.config.editor.readOnly ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="displayBookmarkIcon" type="checkbox"${
			window.siyuan.config.editor.displayBookmarkIcon ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="displayNetImgMark" type="checkbox"${
			window.siyuan.config.editor.displayNetImgMark ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="embedBlockBreadcrumb" type="checkbox"${
			window.siyuan.config.editor.embedBlockBreadcrumb ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="listLogicalOutdent" type="checkbox"${
			window.siyuan.config.editor.listLogicalOutdent ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="listItemDotNumberClickFocus" type="checkbox"${
			window.siyuan.config.editor.listItemDotNumberClickFocus ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="spellcheck" type="checkbox"${
			window.siyuan.config.editor.spellcheck ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="onlySearchForDoc" type="checkbox"${
			window.siyuan.config.editor.onlySearchForDoc ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="codeLineWrap" type="checkbox"${
			window.siyuan.config.editor.codeLineWrap ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="codeLigatures" type="checkbox"${
			window.siyuan.config.editor.codeLigatures ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="codeSyntaxHighlightLineNum" type="checkbox"${
			window.siyuan.config.editor.codeSyntaxHighlightLineNum ? ' checked' : ''
		}/>
</label>
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="virtualBlockRef" type="checkbox"${
			window.siyuan.config.editor.virtualBlockRef ? ' checked' : ''
		}/>
</label>
<div class="fn__flex b3-label config__item">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="virtualBlockRefInclude" value="${
			window.siyuan.config.editor.virtualBlockRefInclude
		}" />
</div>
<div class="fn__flex b3-label config__item">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="virtualBlockRefExclude" value="${
			window.siyuan.config.editor.virtualBlockRefExclude
		}" />
</div>
<div class="fn__flex b3-label config__item">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="plantUMLServePath" value="${
...
<div class="fn__flex b3-label config__item">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="dynamicLoadBlocks" type="number" min="48" max="1024" value="${
...
<div class="fn__flex b3-label config__item">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="blockRefDynamicAnchorTextMaxLen" type="number" min="1" max="5120" value="${
...
<div class="fn__flex b3-label config__item">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="backlinkExpandCount" type="number" min="0" max="512" value="${
...
<div class="fn__flex b3-label config__item">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="backmentionExpandCount" type="number" min="0" max="512" value="${
...
<div class="fn__flex b3-label config__item">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="generateHistoryInterval" type="number" min="0" max="120" value="${
			window.siyuan.config.editor.generateHistoryInterval
		}"/>
</div>
<div class="fn__flex b3-label config__item">
    <div class="fn__flex-1">
    ...
    <span class="fn__space"></span>
    <input class="b3-text-field fn__flex-center fn__size200" id="historyRetentionDays" type="number" min="0" value="${
			window.siyuan.config.editor.historyRetentionDays
		}"/>
</div>
<div class="fn__flex b3-label config__item">
    <div class="fn__flex-1">
    ...
    <select class="b3-select fn__flex-center fn__size200" id="floatWindowMode">
      <option value="0" ${window.siyuan.config.editor.floatWindowMode === 0 ? 'selected' : ''}>${
			window.siyuan.languages.floatWindowMode0
		}</option>
      <option value="1" ${
				window.siyuan.config.editor.floatWindowMode === 1 ? 'selected' : ''
			}>${window.siyuan.languages.floatWindowMode1.replace('${hotkey}', updateHotkeyTip('⌘'))}</option>
      <option value="2" ${window.siyuan.config.editor.floatWindowMode === 2 ? 'selected' : ''}>${
...
<label class="fn__flex b3-label">
    <div class="fn__flex-1">
        ...
        <div class="b3-label__text">${window.siyuan.languages.fontSizeScrollZoomTip.replace(
					'Ctrl',
					updateHotkeyTip('⌘')
				)}</div>
    </div>
    <span class="fn__space"></span>
    <input class="b3-switch fn__flex-center" id="fontSizeScrollZoom" type="checkbox"${
			window.siyuan.config.editor.fontSizeScrollZoom ? ' checked' : ''
		}/>
</label>
<div class="fn__flex b3-label config__item">
    <div class="fn__flex-1">
    ...
    <div class="b3-tooltips b3-tooltips__n fn__flex-center" aria-label="${window.siyuan.config.editor.fontSize}">   
        <input class="b3-slider fn__size200" id="fontSize" max="72" min="9" step="1" type="range" value="${
...
<div class="fn__flex b3-label config__item">
    ...
    <span class="fn__space"></span>
    <div class="b3-tooltips b3-tooltips__n fn__flex-center" aria-label="${
			window.siyuan.config.editor.codeTabSpaces
		}">   
        <input class="b3-slider fn__size200" id="codeTabSpaces" max="8" min="0" step="2" type="range" value="${
					window.siyuan.config.editor.codeTabSpaces
				}">
    </div>
</div>
<div class="b3-label">
    <div class="fn__block">
        ...
        <textarea class="b3-text-field fn__block" id="katexMacros" spellcheck="false">${
		...
		if (fontFamilyElement.tagName === 'SELECT') {
			...
			fetchPost('/api/system/getSysFonts', {}, (response) => {
				response.data.forEach((item: string) => {
					fontFamilyHTML += `<option value="${item}"${
						window.siyuan.config.editor.fontFamily === item ? ' selected' : ''
					}>${item}</option>`;
				});
		...
		const setEditor = () => {
			...
			fetchPost(
				'/api/setting/setEditor',
				{
					...
					codeSyntaxHighlightLineNum: (editor.element.querySelector('#codeSyntaxHighlightLineNum') as HTMLInputElement)
						.checked,
					...
					listItemDotNumberClickFocus: (
						editor.element.querySelector('#listItemDotNumberClickFocus') as HTMLInputElement
					).checked,
					...
					blockRefDynamicAnchorTextMaxLen: parseInt(
						(editor.element.querySelector('#blockRefDynamicAnchorTextMaxLen') as HTMLInputElement).value
					),
					backlinkExpandCount: parseInt(
						(editor.element.querySelector('#backlinkExpandCount') as HTMLInputElement).value
					),
					backmentionExpandCount: parseInt(
						(editor.element.querySelector('#backmentionExpandCount') as HTMLInputElement).value
					),
					...
					generateHistoryInterval: parseInt(
						(editor.element.querySelector('#generateHistoryInterval') as HTMLInputElement).value
					),
					historyRetentionDays: parseInt(
						(editor.element.querySelector('#historyRetentionDays') as HTMLInputElement).value
					),

...
export class Editor extends Model {
	...
	constructor(options: { app: App; tab: Tab; blockId: string; rootId: string; mode?: TEditorMode; action?: string[] }) {
		super({
			app: options.app,
			id: options.tab.id
		});
	...
	private initProtyle(options: { blockId: string; action?: string[]; rootId: string; mode?: TEditorMode }) {
